...
const getImageUrl = (thumbnail: any): string => {
  if (!thumbnail) {
    return 'https://via.placeholder.com/400x250/667eea/ffffff?text=Course+Image'
  }
  // If thumbnail is already a string URL, return it
...
const handleImageError = (event: Event) => {
  ...
  target.src = 'https://via.placeholder.com/400x250/667eea/ffffff?text=Course+Image'
}
