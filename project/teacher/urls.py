...
urlpatterns = [
    ...
    path('api/dashboard/', views.teacher_dashboard_api, name='teacher_dashboard_api'),
    path('api/courses/', views.teacher_courses_api, name='teacher_courses_api'),
    path('api/courses/create/', views.create_teacher_course_api, name='create_teacher_course_api'),
